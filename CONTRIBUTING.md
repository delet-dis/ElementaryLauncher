...
1. Clone forked repository `git clone git@github.com:YOUR-USERNAME/ElementaryLauncher.git`

All changes should be based on the `main` branch. Push to your fork and [submit a pull request](https://github.com/delet-dis/ElementaryLauncher/compare) against the `main` branch.
